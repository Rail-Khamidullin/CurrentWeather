...
class MyView {
    ...
    var sunriseLable: UILabel = {
        ...
        sunriseLable.textColor = UIColor.init(named: "Color")
        return sunriseLable
    }()
    //    Время рассвета
    var sunriseLableTime: UILabel = {
        ...
        sunriseLableTime.textColor = UIColor.init(named: "Color")
    ...
    var sunsetLable: UILabel = {
        ...
        sunsetLable.textColor = UIColor.init(named: "Color")
        return sunsetLable
    }()
    //    Время заката
    var sunsetLableTime: UILabel = {
        ...
        sunsetLableTime.textColor = UIColor.init(named: "Color")
    ...
    var searchWeatherButton: UIButton = {
        ...
        searchWeatherButton.titleLabel?.font = .systemFont(ofSize: 17)
